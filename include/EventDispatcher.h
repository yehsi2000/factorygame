...
class EventHandle {
public:
    EventHandle(class EventDispatcher* dispatcher, std::type_index typeIndex, size_t id);
    ~EventHandle();
...
public:
    ...
    // Overload to accept shared_ptr for convenience, but still dispatches immediately.
