 ...
 * exists on the entity, it will be detached first before the new one is attached.
 * 
 ...
 */
void AttachTimer(Registry& registry, TimerManager& timerManager, EntityID entity, TimerId id, float duration, bool isRepeating);
 ...
 */
void DetachTimer(Registry& registry, TimerManager& timerManager, EntityID entity, TimerId id);
