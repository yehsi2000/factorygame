...
EventHandle::EventHandle(EventDispatcher* dispatcher, std::type_index typeIndex, size_t id)
...
EventHandle::EventHandle(EventHandle&& other) noexcept
    : dispatcher(other.dispatcher), typeIndex(other.typeIndex), callbackID(other.callbackID) {
